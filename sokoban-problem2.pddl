...
(define (problem sokoban2)
	...
	(:init 
		...
		(adjacent X06-G X05-G left) (adjacent X06-G X06-F down) (adjacent X06-G X06-H up)
		(adjacent X06-H X05-H left) (adjacent X06-H X06-G down)
	)
	...
	(:goal
		...
		(and (block-at block1 X02-G) (block-at block2 X05-B) )
